...
{
    public enum Type{
        Air, Dirt, Grass, Stone, Trunk, Leaves, Wood, Roof
    }
    ...
    static Dictionary<Type, GridCoordinates> textureGridCoordinates = new Dictionary<Type, GridCoordinates>(){
        ...
        {Voxel.Type.Wood, new GridCoordinates(new Vector2Int(0,6),new Vector2Int(0,6),new Vector2Int(0,6))},
        {Voxel.Type.Roof, new GridCoordinates(new Vector2Int(0,7),new Vector2Int(0,7),new Vector2Int(0,7))}
    };
